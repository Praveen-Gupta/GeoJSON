...
using namespace MIVector::geometry;

namespace MIV_Geometry_Tests
{
	TEST_CLASS(MIV_Geometry_Tests)
	{
	public:
		...
		TEST_METHOD (MIVTest_MultiPoint)
		{
		...
		TEST_METHOD (MIVTest_LineString) 
		{
		...
		TEST_METHOD (MIVTest_MultiLineString)
		{
		...
		TEST_METHOD(MIVTest_MultiPolygon)
		{
		...
		TEST_METHOD(MIVTest_GeometryCollection)
		{
		...
		*/
		...
		TEST_METHOD(MIVTest_FeatureCollection)
		{
		...
		TEST_METHOD (MIVTest_ForEachPoint)
		{
			...
			using my_geometry = MIVector::util::variant<point<double>>;
			...
			assert(count_points(MIVector::util::variant<my_point>(my_point{ 0, 1 })) == 1);
		}

		TEST_METHOD(MIVTest_Envelope)
		{
